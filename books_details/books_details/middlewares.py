...
class BooksDetailsSpiderMiddleware:
...
class BooksDetailsDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class RandomUserAgentMiddleware(object):
    """
    Middleware to select random user-agent for each request.
    """
    def process_request(self, request, spider):
        user_agents = [
        ...
        spider.logger.info(f"User-Agent used: {user_agent}")
